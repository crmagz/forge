...
```bash
python3 "${CLAUDE_SKILL_DIR}/scripts/create_handoff.py" [task-slug]
```

Example: `python3 "${CLAUDE_SKILL_DIR}/scripts/create_handoff.py" implementing-user-auth`
...
```bash
python3 "${CLAUDE_SKILL_DIR}/scripts/validate_handoff.py" <handoff-file>
```
...
```bash
python3 "${CLAUDE_SKILL_DIR}/scripts/check_staleness.py" <handoff-file>
```
